...
class TextImgDataset(data.Dataset):
    ...
    def load_captions(self, data_dir, filenames, args):
        all_captions = []
    ...
    def build_dictionary(self, train_captions, test_captions, args):
    ...
    def load_text_data(self, data_dir, split, args):
        ...
        if not os.path.isfile(filepath):
            train_captions = self.load_captions(data_dir, train_names, args)
            test_captions = self.load_captions(data_dir, test_names, args)

            train_captions, test_captions, ixtoword, wordtoix, n_words = \
                self.build_dictionary(train_captions, test_captions, args)
