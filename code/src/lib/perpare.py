...
from models.DAMSM import RNN_ENCODER, CNN_ENCODER, XLM_ENCODER
...
def prepare_models(args):
    ...
    image_encoder.eval()
    # text encoder
    print(args.transformer,"transformer")
    if args.transformer == 'xlm':
      print("here in xlm transformer")
      text_encoder = XLM_ENCODER()
      text_encoder.cuda()
      for p in text_encoder.parameters():
        p.requires_grad = False
      text_encoder.eval()
    elif args.transformer == 'rnn':
